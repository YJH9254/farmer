...
<body>
	...
	<ol>
		<li>JSP include : 
			포워드처럼 request와 response를 다른 jsp로 그대로 전달하여
			처리를 진행한 후에 결과를 가지고 다시 돌아오는 기능.
			다른 페이지로 잠깐 갔다가 다시 돌아오는 기능이기 때문에 
			include하는 페이지에서는 pageScope의 값을 사용할 수 없다. 
		</li>
		<li>
			File include :
	...
	<a href="./include2/index.jsp">JSP include</a>
