...
<body>
	...
	<ul>
		...
		<li>동적인 웹 페이지를 생성하기 위한 Java API</li>
	...
	<ul>
		...
		<li>단순 응답이 아닌 상황에 다라 변화하는 동적 페이지 처리를 담당한다</li>
