...
<body>
	...
	<ul>
		...
		<li>뷰 쪽에서 자주 쓰이는 자바 문법들을 html 태그와 유사한 형식으로
			사용할 수 있는 기능을 제공한다</li>
		<li>자바의 모든 기능을 사용할 수 있는 것은 아니지만
			뷰 페이지를 만들기에는 충분한 기능들이 태그 형식으로 구현되어 있다</li>
	...
	<h5>어트리뷰트는 JSP 페이지에서 쉽게 꺼내 쓸 수 있는 기능을 제공한다</h5>
	
	<div>그냥 쓰기 : ${fruit} (가장 가까운 영역의 값을 사용)</div>
